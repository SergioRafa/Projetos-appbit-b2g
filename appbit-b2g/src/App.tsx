...
export default function App() {
  ...
  const lidarComConsulta = (e: React.FormEvent) => {
    ...
    // Simulação da resposta da IA do Pedro rodando em background
    setTimeout(() => {
  ...
  return (
    <div style={{ display: 'flex', height: '100vh', width: '100vw', fontFamily: 'sans-serif', backgroundColor: '#0f172a', color: '#f8fafc', margin: 0, overflow: 'hidden' }}>
      ...
      <aside style={{ width: '260px', backgroundColor: '#1e293b', padding: '20px', display: 'flex', flexDirection: 'column', gap: '20px', borderRight: '1px solid #334155' }}>
        ...
        {/* 🔥 Corrigido para refletir o escopo acordado na reunião */}
      ...
      <main style={{ flex: 1, display: 'flex', flexDirection: 'column', position: 'relative' }}>
        ...
        {/* Espaço onde o Mapa vai morar com o console de IA flutuante */}
        <div style={{ flex: 1, position: 'relative', zIndex: 1 }}>
          <MapaVisent />

          {/* CONSOLE FLUTUANTE DA IA (Aparece elegantemente sobre o mapa no canto esquerdo) */}
          <div style={{
            position: 'absolute',
            top: '20px',
            left: '20px',
            zIndex: 1100, // Garante que fica visível por cima das camadas do Leaflet
            width: '340px',
            maxHeight: '75%',
            backgroundColor: 'rgba(30, 41, 59, 0.85)', // Efeito glassmorphism translúcido
        ...
        {/* Formulário da Barra de Consulta com IA */}
